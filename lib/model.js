...
RestberryModel.prototype.getFieldNamesExpand = function() {
    if (this._fieldNamesExpand)  return this._fieldNamesExpand;
    return this.restberry.waf.getOptions().expand;
};
...
RestberryModel.prototype.getFieldNamesVisible = function(fieldName) {
    var options = this.restberry.waf.getOptions();
...
RestberryModel.prototype.hrefs = function(query, next) {
    var self = this;
    var options = self.restberry.waf.getOptions();
    self.count(query, function(total) {
        var href = self.href();
...
RestberryModel.prototype.preRemove = function(preRemove) {
    this._methods._preRemove = preRemove;
    return this;
};

RestberryModel.prototype.preSave = function(preSave) {
    this._methods._preSave = preSave;
    return this;
};
...
RestberryModel.prototype.setFieldNamesExpand = function(fieldNamesExpand) {
    this._fieldNamesExpand = fieldNamesExpand;
};

RestberryModel.prototype.shouldOutputExpand = function(fieldName, expand) {
    expand = expand || this.getFieldNamesExpand();
    fieldName = fieldName || this.singularName();
    return _.contains(expand, fieldName);
};

RestberryModel.prototype.shouldOutputShow = function(fieldName, fields) {
    fieldName = fieldName || this.singularName();
    fieldName = _.first(fieldName.split('.'));
    fields = fields || this.getFieldNamesVisible();
...
RestberryModel.prototype.validate = function(data, next, onError) {
    var req = this.restberry.waf.getReq();
