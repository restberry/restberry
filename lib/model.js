...
RestberryModel.prototype._setupRoutes = function() {
    if (this._model)  this.routes = this.restberry.routes.copy(this);
};
...
RestberryModel.prototype.copy = function() {
    ...
    if (this._options)  model._options = this._options.copy();
    return model;
};
...
RestberryModel.prototype.options = function() {
    if (!this._options)  this._options = this.restberry.waf.options();
...
RestberryModel.prototype.preRemove = function(preRemove) {
    if (!_.isArray(this._methods._preRemove))  this._methods._preRemove = [];
    this._methods._preRemove.push(preRemove);
    return this;
};

RestberryModel.prototype.preSave = function(preSave) {
    if (!_.isArray(this._methods._preSave))  this._methods._preSave = [];
...
RestberryModel.prototype.setOptions = function(options) {
    var model = this.copy();
    model._options = options || this.restberry.waf.options();
    return model;
};
