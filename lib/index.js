...
Restberry.prototype.use = function(module) {
    ...
    if (modules.isWAF(module)) {
        ...
        this.odm = module;
    } else if (_isRestberryAuth(module)) {
        this.auth = module;
...
var _isRestberryAuth = function(module) {
    if (!module.__class__)  return false;
    return module.__class__.__className__ === RestberryAuth.__className__;
};
